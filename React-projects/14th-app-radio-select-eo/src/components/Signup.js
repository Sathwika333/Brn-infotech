...
function Signup() {
    ...
    let confpasswordRegExp = new RegExp(passwordRegExp.source);
    ...
    <div className="App">
        ...
        <div>
            ...
            <div>
                ...
                <input type="password" id="password" placeholder="enter password" ref={confpasswordInputRef}
                onChange={()=>{
                    validateName(confpasswordInputRef,confpasswordResultRef,confpasswordRegExp)
                }}></input>
